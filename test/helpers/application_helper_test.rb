...
class ApplicationHelperTest < MiniTest::Rails::ActionView::TestCase
  ...
  def test_nav_item_link
    stub(:current_page?, false) do
      assert_equal '<li><a href="/people">People</a></li>', nav_item_link('People', dudes_path)
    end
  end

  def test_nav_item_link_active
    stub(:current_page?, true) do
      assert_equal '<li class="active"><a href="/people">People</a></li>', nav_item_link('People', dudes_path)
    end
  end
end
